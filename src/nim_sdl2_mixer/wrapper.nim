...
const
  ...
  srcDir = baseDir / "build" / "sdl2_mixer"
...
static:
  cDebug()
  cDisableCaching()
  let contents = readFile(srcDir/"SDL_mixer.h")
  let newContents = contents.replace("""#include "SDL_stdinc.h"
#include "SDL_rwops.h"
#include "SDL_audio.h"
...
""").
  ...
  writeFile(srcDir/"SDL_mixer.h", newContents)
...
when not defined(SDL_Static):
  cImport(SDL_mixer_Path, recurse = false, dynlib = "SDL_mixer_LPath")
else:
  cImport(SDL_mixer_Path, recurse = false)
